    ...
    return (
        <div className="bg-gray-50 font-sans text-gray-800">
            <header
                ...
                style={{backgroundImage: 'url(https://img.freepik.com/free-photo/cargo-ship-parked-harbor-sunny-day-sunset_181624-4056.jpg?ga=GA1.1.1154289487.1757069524&semt=ais_hybrid&w=740&q=80)'}}
            >
                        ...
                        <div className="w-full md:w-1/2">
                            <div
                                ...
                                style={{
                                    ...
                                    backgroundImage: 'url(https://img.freepik.com/free-photo/panoramic-shot-oil-rigs-sea-with-beautiful-sunset_181624-20797.jpg?ga=GA1.1.1154289487.1757069524&semt=ais_hybrid&w=740&q=80)',
